...
#### Week 2 - NCDXF Beacon Listening (S)
...
#### Week 3 - Make a contact with a different continent on 80m or 160m (W)
...
#### Week 4 - Research the history of your callsign (S)
...
#### Week 5 - Update your profile on QRZ.com, HamQTH.com, etc. (S)
...
#### Week 7 - Where are the DXpeditions? (7)
...
#### Week 8 - Encourage someone to take their ham radio license exam (W)
...
#### Week 9 - Try to work an FM repeater on 10m (S)
...
#### Week 10 - Listen to an amateur radio satellite (S)
...
#### Week 11 - Receive a weather satellite image (W)
...
#### Week 12 - Make a contact with an "unusual" antenna (W)
...
#### Week 13 - Make a QSO from an unusual location and post a picture! (s)
...
#### Week 14 - Implement and describe a backup solution for your ham radio log (S)
...
#### Week 15 - Monitor a transmission and take notes of the field strength (W)
...
#### Week 16  - Make a contact with a xOTA station (S)
...
#### Week 17 - Which VHF/UHF repeater is closest to your location? (S)
...
#### Week 18 - Make a QSO in one digital voice mode (S)
...
#### Week 19 - Simulate an antenna! (N)


#### Week 20 - Decode the RTTY transmission of DWD on 10101 kHz (S)

I need to remember this...FLdigi settings are 450Hz shift, 50 bd, 5N1. Simple reception
![DWD](/img/DWD.png#centre)

#### Week 21 - Create a GNU Radio flowgraph (S)
...
#### Week 22 - Simulate an electric circuit (W)
...
#### Week 23 - How many language can you hear on the radio this week? (W)
...
#### Week 24 - Make a contribution to an Open Source ham radio software package (S)

I think I've got this covered. In the past I've made contributions to the [Open Source radio Wiki](https://opensource.radio/) as well as the [SatNOGS database](https://db.satnogs.org/). For non coders like me these are some of the less well loved contrinutions, documentation. I see thses as important as the code itself. If I can't follow it because it is in Tech Jargon, then its probably ripe for a bit of normal speak. Especially if they are wiki type things.

#### Week 25 - Locate local noise sources in your shack/flat/house (S)
...
#### Week 29 - Make your own xOTA activation (S)
...
#### Week 31 - Try a mode you have never tried before. Hellschreiber? JT65? (S)

New to me. FT8. I've not really been a fan of point and click type modes. PSK31 was as close as I used to get earlier in the century. But my new zBitX has FT8 built in so I thought I'd give it a go. Whilst its not exactly my cup of tea it could be a useful mode for POTA or SOTA if I'mstruggling to get contacts. I can't see it being a primary more though. One mode I've fancied having a go at is Hell. I must make some time for that

#### Week 32 - Listen to a broadcast station from another country (S)

Like DD1MAT, I listened to the Antarctic brioadcast from Ascension island and the UAE (as well as the UK). This broasdcast by the BBC send messages to those overwintering in the various Antarctic bases. Its probably not necessary nowadays but is a lovely thing to do for those who must be incredibly isolated. I've missed the love broadcast so many times and Cerys Matthews is a regular on 6Music for me. Will listen again!

#### Week 33  - Build an antenna and make a contact with it (S)

Every time I make an HF contact at home it is with a home made antenna. A W3EDP at home andvarious end fed or vertical antennas for HF portable. The only commercial antenna I have for ham stuff is th ewhite stick for VHF & UHF. Its been battered by the wind and a bit wonky now but still works fine. For xOTA VHF I use a flowerpot antenna that uses a [3D print](https://www.printables.com/model/312517-flowerpot-antenna) which is also my answer to HC43

#### Week 34 - Match an impedance!

#### Week 35 - Receive a weather fax transmission on HF (S)
...
#### Week 39 - Make a 2-way contact with an output power of 100 mW or less.
...
Done a few 3D prints for ham radio. I keep the useful ones on [Printables](https://www.printables.com/@g7kse_197848) and am usually work (slowly) on something. Recentley enclosures for APRS trackers or portable Meshtastic nodes have been taking up a bit of my time. These aren't particularly complex to design or print but making a common design has been a bit more time consuming than I had thought. 
...
#### Week 52 - Create an Infographic or Webcomic!
